...
class HalfEdge:
	...
	#Returns the half-edge with the highest node number of the graph
	...
	#Returns the half_edge with the smalles node number
	...
	#Retunrs a dictonary of nodes. The key is node number and the value is a list of
	...
	#needed to get the correct node nubers, colosr, etc. for the new opposite
	#half-edge
