...
from unoptimized_heuristic import treewidth_decomp, min_degree_heuristic, min_fill_in_heuristic
...
def main():
    ...
    if TEST_APPROXIMATE:
        ...
        decomp, tree_width = pr.runcall(treewidth_decomp, G, min_degree_heuristic)
